...
public:
  ...
  ~CourseOfferings();
  CourseOfferings(const CourseOfferings& course);
  CourseOfferings& operator =(const CourseOfferings& right);


  // other nstructors and methods provided in the starter code
...
bool operator==(const CourseOfferings & lhs, const CourseOfferings & right);
